...
TEST(Char2, { cell n; return Utils::ReadChar("\\\\", n) == OK && n == '\\'; })
TEST(Char2, { cell n; return Utils::ReadChar("\\n", n) == OK && n == '\n'; })
TEST(Char2, { cell n; return Utils::ReadChar("\\0", n) == OK && n == 0; })
TEST(Char2, { cell n; return Utils::ReadChar("\\55", n) == OK && n == 055; })
TEST(Char2, { cell n; return Utils::ReadChar("\\55;", n) == OK && n == 055; })
TEST(Char2, { cell n; return Utils::ReadChar("\\'", n) == OK && n == '\''; })
TEST(Char2, { cell n; return Utils::ReadChar("\\", n) == ERROR_INVALID_ESCAPE; })
TEST(Char2, { cell n; return Utils::ReadChar("\\y", n) == ERROR_INVALID_ESCAPE; })
TEST(Char2, { cell n; return Utils::ReadChar("\\9", n) == ERROR_INVALID_ESCAPE; })
TEST(Char2, { cell n; return Utils::ReadChar("\\x;", n) == ERROR_NAN; })
TEST(Char2, { cell n; return Utils::ReadChar("\\xH;", n) == ERROR_NAN; })
